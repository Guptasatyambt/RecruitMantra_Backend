...
const{handleregister,handledetails,handlelogin,getinfo,handlestart,givecoins,handleimage,updateyear,updateresume}=require('../controller/usercontroller')
...
// router.post('/uploadvideo',validation,videoupload); // send "uid" and "video" in body
