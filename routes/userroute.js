...
const {test, handleregister, handledetails, handlelogin, getinfo, getcoin, givecoins, handleimage, updateyear, updateresume, generateAndSendUrl, changePassword, updatepassword, uploadassets, sendVarifyEmailOtp, validateEmailotp } = require('../controller/usercontroller')
